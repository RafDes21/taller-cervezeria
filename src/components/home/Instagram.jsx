    ...
    >
      ...
      <div className="row mx-0">
        <div className="col-12 col-md-6 caja-instagram">
          <img className="instagram-imagenes" src="./assets/instagram/img1.png" alt="imagenInstagram" />
          <img className="instagram-imagenes" src="./assets/instagram/img2.png" alt="imagenInstagram" />
          <img className="instagram-imagenes" src="./assets/instagram/img3.png" alt="imagenInstagram" />
        </div>
